...
export const Icons = {
  back: require('../Assets/Icons/back_icon/back_icon.png'),
  travel: require('../Assets/Icons/travel_icon/travel_icon.png'),
  flight: require('../Assets/Icons/flight_icon/flight_icon.png'),
